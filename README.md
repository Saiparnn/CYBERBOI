...
#### **2. Port Scanner and Network Alerts**
<p align="center">
...
<ul>
  ...
  <br>
  <details>
    <summary>NOTE: Acunetix Premium On-Premises is no longer supported on macOS. If you are using macOS, you will need to move to one of the following options:</summary>
    <ul>
      <li>Move to Acunetix Premium Online</li>
      <li>Use Acunetix on a Virtual machine</li>
      <li>Use Acunetix on Docker</li>
    </ul>
  </details>
  <li>
    Supported Browsers
